...
public class ConnectionHandler implements Runnable
{
	 ...
	 * 
	 * @param socket - connection to client RoomList - reference to master list
	 * of all rooms ServerUserList - reference to master list of all clients
	 * 
	 * @throws IOException - if the socket is somehow closed during this process
	 */
	 ...
	 * 
	 * @param String - username for this connectionHandler
	 */
	...
	// method to build a string containing all of the connected rooms of the
	// user
